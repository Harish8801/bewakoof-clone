...
import Common_slidergrid from "./common_slidergrid";
...
function Landingpage()
{
    return (<div style={{height:"auto",width:"98%",boxSizing:"border-box"}}>
         <MenuSlider/>
          ...
          <Common_slidergrid header={"BESTSELLERS FOR MEN"} data={Best_seller_data}/>
          <Common_slidergrid header={"T-SHIRTS UNDER 299"} data={T_shirt_299_data}/>
